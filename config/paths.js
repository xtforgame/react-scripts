...
module.exports = {
  ...
  appIndexJs: resolveModule(resolveApp, 'src/front-end/index'),
  appPackageJson: resolveApp('package.json'),
  appSrc: resolveApp('src/front-end'),
...
if (
  ...
  module.exports = {
    ...
    appIndexJs: resolveModule(resolveOwn, `${templatePath}/src/front-end/index`),
